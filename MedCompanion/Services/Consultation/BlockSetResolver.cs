...
namespace MedCompanion.Services.Consultation
{
    ...
    public class BlockSetResolver
    {
        ...
        private static List<BlockDefinition> GetDefaults() => new()
        {
            ...
            new() { Key = "motif",                   Title = "Motif de consultation",           ExpectedThemes = new() { "motif_principal" },                                       TriggerType = "core_fixed", Order = 1 },
            new() { Key = "identite",                Title = "Identité",                        ExpectedThemes = new() { "accompagnant", "classe", "ecole" },                       TriggerType = "core_fixed", Order = 2 },
